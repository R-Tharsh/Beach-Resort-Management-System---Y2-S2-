...
<!-- Title+Button -->
<label for="show" class="title">Book Now</label>
<!-- Form -->
<form action="insertuserveichleBook" method="post" class="form">
    ...
    <div class="group">
        ...
        <div class="col-2">
            <input type="text" id="f-name"name="user" value="${user}"   placeholder="AMIGOS" />
        </div>
    </div>
    <!-- Last Name -->
    <div class="group">
        ...
        <div class="col-2">
            <input type="text" name="nic" id="l-name" placeholder="99#######X" />
        </div>
    </div>
    <!-- Password -->
    <div class="group">
        ...
        <div class="col-2">
            <input type="nmber" " name="mobile" placeholder="+94######### " />
        </div>
    </div>
    <!-- Email -->
    <div class="group">
        ...
        <div class="col-2">
            <input type="email" name="email" id="email" placeholder="amigos@email.com" />
        </div>
    </div>
   <div class="group">
        <div class="col-1">
     ...
     <div class="group">
        ...
        <div class="col-2">
            <input type="number" name="noofkm"  placeholder="5 - 10" />
        </div>
    </div>
     <div class="group">
        <div class="col-1">
        ...
        <div class="col-2">
            <input type="number" name="cost" placeholder="2500LKR" />
        </div>
    </div>
