  ...
  <%@include file="header.jsp" %>
    <div class="container" style="margin-left: 20%; padding-top:5%">
      ...
      <div class="container" style="padding-top:3%">
        ...
        <a href="<%=request.getContextPath()%>/newRoomBook" class="btn btn-Info" style="margin-left:-10px"><img src="header/images/add.png" class="report">Reserve Room</a>
      </div>
      ...
      <table class="table">
          ...
          <c:forEach var="user" items="${listRoomBooking}">
            ...
            <tr>
              ...
              <td><a href="editRoomBook?id=<c:out value='${user.id}' />"><img src="header/images/edit (2).png" class="edit"></a>
                <a href="deleteRoomBook?id=<c:out value='${user.id}' />"><img src="header/images/delete (2).png" class="edit"></a></td>
            </tr>
          </c:forEach>
          <!-- } -->
        </tbody>
        ...
        <a href="<%=request.getContextPath()%>/roombookpdf" class="btn btn-success" style="margin-left:30px"><img src="header/images/report.png" class="report">Generate Report</a>
      </div>
    </div>
</body>
</html>