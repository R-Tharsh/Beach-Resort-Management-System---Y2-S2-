...
<body>
	...
	<form name = "insert" action = "insertExpense" method = "post">
		...
		<fieldset class="form-group">
		<label>Type</label><br> <input type = "text" name = "type" class="form-control"> <br>
		</fieldset>
		
		<fieldset class="form-group">
		<label>Quantity</label> <br> <input type = "number" name = "quantity" class="form-control" onkeypress="isInputNumber(event)"> <br>
		</fieldset>
		
		<fieldset class="form-group">
		<lable>Total</lable> <br> <input type ="number" name = "total" class="form-control" id = "total" onkeypress="isInputNumber(event)"> 
		</fieldset>
		
		<button type ="submit" name = "submit" onClick = "return validate();" class="btn-xl btn-success">Add Expense</button>
