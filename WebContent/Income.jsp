...
<body >
	...
	<form name = "insert" action = "insertIncome" method = "post">
		...
		<fieldset class="form-group">
		<label>Total</label> <br> <input type ="number" name = "total" id = "total" class="form-control" onkeypress="isInputNumber(event)"> 
		<br>
		</fieldset>
		
		<fieldset class="form-group">
		<lable>Remarks</lable> <br> <input type = "text" name = "remarks" class="form-control"> <br>
		</fieldset>
		
		<button type ="submit" name = "submit" onClick = "return validate();" class="btn-xl btn-success">Add Income</button>
