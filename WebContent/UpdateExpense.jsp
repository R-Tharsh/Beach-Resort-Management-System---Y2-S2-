...
<body >
	...
	<form action = "UpdateExpense" method = "post">
		...
		<fieldset class="form-group">
		<lable>Division</lable> <select id = "div" name = "division" class="form-control">
		...
		<fieldset class="form-group">
		<lable>Type</lable> <br> <input type = "text" name = "type" class="form-control" value ="<%= type %>"> <br>
		</fieldset>
		
		<fieldset class="form-group">
		<lable>Quantity</lable> <br> <input type = "text" name = "quantity" class="form-control" value ="<%= quantity %>" onkeypress="isInputNumber(event)"> <br>
		</fieldset>
		
		<fieldset class="form-group">
		<lable>Total</lable> <br> <input type ="text" name = "total" class="form-control" value ="<%= total %>" id = "total" onkeypress="isInputNumber(event)"> 
		</fieldset>
