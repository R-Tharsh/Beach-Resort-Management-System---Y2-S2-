...
<body >
	...
	<form action = "DeleteExpense" method = "post">
		...
		<fieldset class="form-group">
		<lable>Date</lable><br> <input type = "text" name = "date" class="form-control" value ="<%= date %>" readonly> <br><br>
		...
		<fieldset class="form-group">
		<lable>Type</lable> <br> <input type = "text" name = "type" class="form-control" value ="<%= type %>" readonly> <br>
		</fieldset>
		
		<fieldset class="form-group">
		<lable>Quantity </lable><br> <input type = "text" name = "quantity" class="form-control" value ="<%= quantity %>" readonly> <br>
		</fieldset>
