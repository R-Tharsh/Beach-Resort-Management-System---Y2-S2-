...
<body>
	...
	Phrase eventname = new Phrase("Event Name", boldFont);
	...
	while (rs.next()) {
		...
		p5.add(rs.getString("eventname"));
		p6.add(rs.getString("facilities"));
