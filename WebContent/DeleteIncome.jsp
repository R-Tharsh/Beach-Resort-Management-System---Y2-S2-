...
<body>
	...
	<form action = "DeleteIncome" method = "post">
		...
		<fieldset class="form-group">
		<lable>Remarks</lable> <br> <input type = "text" name = "type" class="form-control" value ="<%= remarks %>"> <br>
		</fieldset>
		...
		<button  type ="submit" name = "submit" onClick = "return validate();" class="btn-xl btn-danger">Delete Income</button>
