...
<body>
	...
	<button type ="submit" name = "submit" class="btn-xl btn-info" >View All Expenses</button>
	<br><br>
	...
	<button type ="submit" name = "submit" onClick = "return validate();" class="btn-xl btn-info">Search</button>
