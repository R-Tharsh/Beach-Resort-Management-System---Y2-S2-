...
<body >
	...
	<form action = "UpdateIncome" method = "post">
		...
		<lable>InvoiceID</lable> <input type = "text" name ="id" class="form-control" value = "<%= id %>" readonly><br>
		</fieldset>
		
		<fieldset class="form-group">
		<label>Date</label> <br> <input type = "text" name = "date" id = "datepicker" class="form-control" value ="<%= date %>"> <br>
		</fieldset>
		
		<fieldset class="form-group">
		<label>Division</label> <select id = "div" name = "division" class="form-control">
		...
		<fieldset class="form-group">
		<label>Total</label><br> <input type ="text" name = "total" class="form-control" value ="<%= total %>" id = "total" onkeypress="isInputNumber(event)"> 
		</fieldset>
		
		<fieldset class="form-group">
		<label>Remarks</label> <br> <input type = "text" name = "remarks" class="form-control" value ="<%= remarks %>"> <br>
		</fieldset>
		
		<button type ="submit" name = "submit" onClick = "return validate();" class="btn-xl btn-primary">Update Income</button>
