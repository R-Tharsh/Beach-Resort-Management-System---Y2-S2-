...
<body style="background-color: #F3F3F3">
  ...
  <div class="container" style="margin-left: 20%; padding-top: 5%">
    <h3 class="text-center"
      style="margin-left: 80px; font-size: 50px; font-weight: bold">Tour
      Package Details</h3>
    <hr style="width: 1050px; border: 2px solid #fff">
    <div class="container text-left">

      <a href="<%=request.getContextPath()%>/newtransport"
        class="btn btn-Info" style="margin-left: -10px; margin-top: 20px"><img
        src="header/images/add.png" class="report">Add Package</a>
    </div>
      ...
      <tbody>
        ...
        <c:forEach var="user" items="${listTransport}">
          ...
          <tr>
            ...
            <td><a href="edittransport?id=<c:out value='${user.id}' />"><br>
              <img src="header/images/edit (2).png" class="edit"></a>
              &nbsp;&nbsp;&nbsp;&nbsp; <a
              href="deletetransport?id=<c:out value='${user.id}' />"><img
